package com.xzzz.Java框架;

import com.xzzz.A1_java.high.零散知识点.Java的状态.概念;
...
public class Spring {
    /**
     ...
     8. spring bean的生命周期
        @see com.xzzz.C1_framework.Spring.spring生命周期.jpg
     ...
     9.Spring支持的几种bean的作用域
        @see com.xzzz.C1_framework.Spring.注解.概念
     ...
     10. Spring框架中的单例Beans是线程安全的么？
        ...
        @see com.xzzz.JavaBase.C_线程.线程本地_ThreadLocal
