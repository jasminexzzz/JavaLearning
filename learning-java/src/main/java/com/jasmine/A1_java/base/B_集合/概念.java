package com.jasmine.A1_java.base.B_集合;
...
public class 概念 {
    ...
    |   |   |   HashMap初始是一个
    |   |   |   数组(散列表)
                @see com.jasmine.B1_data_structure.散列表哈希表结构.概念
                +
                单向链表
                @see com.jasmine.B1_data_structure.线性结构.概念
                的组合,但当链表长度大于等于7(TREEIFY_THRESHOLD - 1)时,
                链表会转换为一颗红黑树.
                @see com.jasmine.B1_data_structure.树型结构.概念
