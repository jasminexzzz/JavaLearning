package com.xzzz.C1_framework.Spring.注解;
    ...
    /**
     ...
     一. Bean配置的相关注解
        ...
        @PostConstruct
            ...
            执行步骤可查看{@link com.xzzz.C1_framework.Spring.spring生命周期.jpg}
...
======================================================================================================================================
    二. bean的注册
        ...
        @Configuration
            意思该类为配置bean的集合
            @see com.xzzz.bean.ConfigurationAnnotationTest
...
======================================================================================================================================
     ...
     五. 请求返回
        ...
        @RequestBody
            ...
            @see com.xzzz.controller.GameController.updGameAndPlatValid
