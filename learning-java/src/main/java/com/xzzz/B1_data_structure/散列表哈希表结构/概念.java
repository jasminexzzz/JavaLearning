package com.xzzz.B1_data_structure.散列表哈希表结构;


import com.xzzz.Other.基础数学知识.基础名词.互质数;
...
public class 概念 {
    ...
    二. O(n) 查找和 O(1) 查找, 两个模型
        ...
        能存储 0～9 这10个数字：
            @see com.xzzz.B1_data_structure.散列表哈希表结构.链接法解决碰撞.SingleIntSet

            ★新需求！同样只需要保存10个数字, 只不过这次不是保存0～9, 而是需要保存10～19, 怎么办？很简单, 实现一个槽里的值与地址的映射函数 H() 即可：
            @see com.xzzz.B1_data_structure.散列表哈希表结构.链接法解决碰撞.SingleIntSet2

            ★★新需求！新需求！还是存储10个数字, 只不过数字的范围是0～19.如何把20个数字存放到10个槽里？还能怎么办, 2人住1间咯.略微修改一下 H() 函数
            @see com.xzzz.B1_data_structure.散列表哈希表结构.链接法解决碰撞.SingleIntSet3
        ...
        2. 用链接法处理碰撞
            ...
            通俗的讲就是
                ...
                @see com.xzzz.B1_data_structure.散列表哈希表结构.链接法解决碰撞.SingleIntSet4
            ...
            2). <除法散列法>
                ...
                @see com.xzzz.B1_data_structure.散列表哈希表结构.链接法解决碰撞.SingleIntSet4 使用除法散列法计算H()的返回值
                ...
                @see com.xzzz.B1_data_structure.散列表哈希表结构.链接法解决碰撞.IntSet2
        ...
        1.开放寻址法处理碰撞
            ...
            1).<线性探查>
                ...
                @see com.xzzz.B1_data_structure.散列表哈希表结构.开放寻址法解决碰撞.IntSet1
            ...
            如下：
                @see com.xzzz.B1_data_structure.散列表哈希表结构.开放寻址法解决碰撞.IntSet2
            ...
            个偏移量依赖 i 的平方：
                ...
                @see com.xzzz.B1_data_structure.散列表哈希表结构.开放寻址法解决碰撞.IntSet3
            ...
            得下一个空槽了。
                @see com.xzzz.B1_data_structure.散列表哈希表结构.开放寻址法解决碰撞.IntSet4
    ...
    及HashTable。
        ...
        1). 能不能支持所有的对象而不仅限于整数？
            ...
            @see com.xzzz.B1_data_structure.散列表哈希表结构.支持任何对象.HashSet1
        ...
        2). 让 HashSet 支持所有整数
            ...
            @see com.xzzz.B1_data_structure.散列表哈希表结构.支持任何对象.HashSet2
