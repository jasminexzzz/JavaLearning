package com.xzzz.B3_design_mode.装饰器模式_Decorator;
...
public class 概念 {
    /**
     ...
     system.out.print("控制台")
                ...
                @see com.xzzz.B3_design_mode.装饰器模式_Decorator.演变例子_结合工厂.LogToAll
                这个方法没有错误,但他有几个问题.
                ...
                例如:
                @see com.xzzz.B3_design_mode.装饰器模式_Decorator.演变例子_结合工厂.LogImpl2
            ...
            5). 那么为了解决上面的问题,就可以用装饰器模式
                @see com.xzzz.B3_design_mode.装饰器模式_Decorator.例子1.ZTest
