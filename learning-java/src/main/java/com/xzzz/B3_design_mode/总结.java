package com.xzzz.B3_design_mode;

import com.xzzz.B3_design_mode.责任链模式_Chain.demo1.ZTest;
...
public class 总结 {
    /**
     一. 设计模式的类型
        1. 创建型模式：
            单例模式:
            @see com.xzzz.B3_design_mode.单例模式_Singleton.概念
            建造者模式
            @see com.xzzz.B3_design_mode.建造者模式_builder.例2.UserBuilder
            工厂模式:
            @see com.xzzz.B3_design_mode.工厂模式_Factory.概念
            抽象工厂模式
            @see com.xzzz.B3_design_mode.工厂模式_Factory.抽象工厂
            原型模式
            克隆模式,深拷贝浅拷贝实现

        2. 结构型模式:
            适配器模式
            @see com.xzzz.B3_design_mode.适配器模式_Adapter.概念
            装饰器模式:
            @see com.xzzz.B3_design_mode.装饰器模式_Decorator.概念.md
            桥接模式
            组合模式
            外观模式
            享元模式
            代理模式:
            @see com.xzzz.B3_design_mode.代理模式_Proxy.概念

        3. 行为型模式：
            模版方法模式
            @see com.xzzz.B3_design_mode.模板模式_Template.概念
            命令模式
            迭代器模式
            观察者模式
            @see com.xzzz.B3_design_mode.观察者模式_发布订阅模式_Publish_Subscribe.例3.ZTest
            中介者模式
            备忘录模式
            解释器模式
            状态模式
            策略模式
            @see com.xzzz.B3_design_mode.策略模式_Strategy
            职责链模式
            @see ZTest
            访问者模式
