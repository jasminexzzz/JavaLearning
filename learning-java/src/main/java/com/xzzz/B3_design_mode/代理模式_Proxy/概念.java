package com.xzzz.B3_design_mode.代理模式_Proxy;
    ...
    /**
     ...
     二. 静态代理
        因为代理对象需要与目标对象实现一样的接口,所以会有很多代理类,类太多.同时,一旦接口增加方法,目标对象与代理对象都要维护.
            @see com.xzzz.B3_design_mode.代理模式_Proxy.静态代理
        ...
        2. 来个图
            操作人 ──────> 代理对象 ┬──────> 调用前增强
                                   ...
                                   └──────> 调用后增强
     三. JDK动态代理
        @see com.xzzz.B3_design_mode.代理模式_Proxy.动态代理.例子三.ProxyFactory
        ...
        2. 用人话解释一下
            ...
            JDK动态代理的用法
                ...
                1). ClassLoader loader,
                    ...
                    @see com.xzzz.A1_java.high.JVM.类加载机制.概念
