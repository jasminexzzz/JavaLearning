package com.xzzz.B3_design_mode.工厂模式_Factory;

import com.xzzz.B3_design_mode.工厂模式_Factory.工厂方法.例子1.ZTest;
...
public class 概念 {
    /**
     一. 工厂模式
        ...
        1. 简单工厂(静态工厂)模式
            @see com.xzzz.B3_design_mode.工厂模式_Factory.简单工厂.CarFactory
            ...
            为了解决他的缺点,又有了多方法静态工厂
            @see com.xzzz.B3_design_mode.工厂模式_Factory.简单工厂.MoreMethodCarFactory
