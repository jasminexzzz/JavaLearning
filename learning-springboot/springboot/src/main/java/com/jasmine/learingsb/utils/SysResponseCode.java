...
public enum SysResponseCode {
    ...
    SysResponseCode(Integer httpCode , Integer code, String message) {
     ...
     * @return
     */
    public static SysResponseCode byCode(int code) {
        for (SysResponseCode item : SysResponseCode.values()) {
            if (item.code == code || item.httpCode == code) {
                return item;
            }
        }
        return SysResponseCode.INTERNAL_SERVER_ERROR;
    }
    ...
    public static void main(String[] args) {
        SysResponseCode[] apiResultCodes = SysResponseCode.values();
        List<Integer> codeList = new ArrayList<Integer>();
        for (SysResponseCode apiResultCode : apiResultCodes) {
